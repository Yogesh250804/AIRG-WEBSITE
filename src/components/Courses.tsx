...
import { Clock, BarChart, ChevronRight, LayoutDashboard, CheckCircle, Bell, Award, X, Info, Zap, Cpu, Database, Rocket } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        <div className="mb-4">
           ...
           <h3 className="text-xl font-heading font-bold mt-1 tracking-tight">{course.title}</h3>
        </div>
        
        <div className="flex items-center justify-between text-slate-400 text-[11px] font-bold uppercase tracking-widest mb-8">
        ...
        <button 
          ...
          className="w-full py-4 bg-white/5 border border-white/5 rounded-2xl font-bold text-[11px] uppercase tracking-[0.2em] transition-all hover:bg-white hover:text-slate-950"
        >
          Explore Level
        </button>
      </motion.div>
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          <div className="max-w-2xl">
            <h4 className="text-primary font-bold tracking-[0.2em] text-[11px] mb-6 uppercase">Structured Curriculum</h4>
          ...
          <button className="btn-outline">Download Curriculum</button>
        </div>
